...
public class SensorDataAnomalyProcessor implements ItemProcessor<DailyAgregatedSensorData, DataAnomaly> {
    private static final double THRESHOLD = 0.9;

    @Override
    public DataAnomaly process(DailyAgregatedSensorData item) throws Exception {
